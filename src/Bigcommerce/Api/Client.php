...
class Client
{
    ...
    static private $stores_prefix = '/stores/%s/v3/catalog';
...
exit;
    ...
    {
        return self::getCollection('/products/' . $id . '/custom-fields', 'ProductCustomField');
    }
    ...
    {
        return self::getResource('/products/' . $product_id . '/custom-fields/' . $id, 'ProductCustomField');
    }
    ...
    {
        return self::createResource('/products/' . $product_id . '/custom-fields', $object);
    }
    ...
    {
        return self::updateResource('/products/' . $product_id . '/custom-fields/' . $id, $object);
    }
    ...
    {
        return self::deleteResource('/products/' . $product_id . '/custom-fields/' . $id);
    }
